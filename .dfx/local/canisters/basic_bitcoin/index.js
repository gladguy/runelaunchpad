...
import { idlFactory } from './basic_bitcoin.did.js';
export { idlFactory } from './basic_bitcoin.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BASIC_BITCOIN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./basic_bitcoin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the basic_bitcoin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./basic_bitcoin.did.js")._SERVICE>}
 */
export const basic_bitcoin = createActor(canisterId);
